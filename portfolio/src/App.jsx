    ...
    <div className="min-h-screen p-6 md:p-20 max-w-6xl mx-auto bg-[#020617]">
      ...
      <header className="mb-24 flex flex-col md:flex-row justify-between items-start md:items-end gap-8">
        ...
        <div className="flex flex-wrap gap-4">
          <a href={myResume} target="_blank" rel="noreferrer" download className="bg-cyan-400 text-[#020617] px-6 py-3 rounded-full text-[10px] font-black uppercase tracking-widest hover:bg-white transition-all shadow-lg">
            Download CV
          </a>
          <a href="https://www.linkedin.com/in/sayaligedam/" target="_blank" rel="noreferrer" className="border border-cyan-400/30 bg-cyan-400/5 px-6 py-3 rounded-full text-[10px] font-black uppercase tracking-widest text-cyan-400 hover:text-white transition-all">
            LinkedIn
          </a>
          <a href="mailto:sayaligedam12@gmail.com?subject=Portfolio Inquiry" className="border border-slate-700 bg-slate-900/50 px-6 py-3 rounded-full text-[10px] font-black uppercase tracking-widest text-slate-400 hover:text-cyan-400 hover:border-cyan-400/30 transition-all">
            Email Me
          </a>
        </div>
      </header>
